...
//       // Convert access level to match contract expectations (you might need to adjust this)
//       const contractAccessLevel = accessLevel === "edit" ? 1 : 0; // Assuming 0 = view, 1 = edit
...
// src/components/AccessRequest.jsx
import { useState } from "react";
import { ClipboardDocumentIcon, CheckCircleIcon, ExclamationCircleIcon } from "@heroicons/react/24/outline";
import contractService from "../config/contractService"; 
