...
//       updateProgress("blockchain", 30, "Verifying patient role...");
//       let hasPatientRole = await ContractService.contracts.accessRequests.hasRole(
//       ContractService.ROLES.PATIENT,
//       walletAddress
//     );
...
//       console.log("Register tx:", tx.transactionHash);

//       // wait until the tx is mined
//       hasPatientRole = await ContractService.contracts.accessRequests.hasRole(
//         ContractService.ROLES.PATIENT,
//         walletAddress
//       );
//       if (!hasPatientRole) {
//         throw new Error("Auto-registration failed. Please try registering manually.");
//       }
//     }
...
//       setTimeout(() => {
//         // Generate a mock IPFS hash (in real app, this would come from your IPFS service)
//         const mockIpfsHash = "Qm" + Math.random().toString(36).substring(2) + Math.random().toString(36).substring(2);
...
//       await ContractService.init();
//       console.log("Contract initialized:", ContractService.contracts.medicalRecords.address);
//     }
//       const receipt = await ContractService.addMedicalRecord(
//         ipfsHash,
//         fileType,
...
//       updateProgress("ipfs", 30, "Uploading to IPFS...");
...
//           <p>File: {file ? fileName : 'No file selected'}</p>
