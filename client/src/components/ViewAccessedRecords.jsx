...
//             patientName: request.patientName || `Patient ${request.patient.substring(0, 6)}`,
//             accessGranted: request.timestamp ? new Date(Number(request.timestamp) * 1000) : new Date(),
...
//       link.href = fileUrl;
//       link.download = `patient-record-${record.patientName}-${record.id}.${record.fileType.toLowerCase()}`;
//       document.body.appendChild(link);
//       link.click();
//       document.body.removeChild(link);
      
//       console.log(`Downloading patient record from IPFS: ${record.ipfsHash}`);
...
// src/components/ViewAccessedRecords.jsx
import { useState, useEffect } from "react";
import {
  DocumentTextIcon,
  EyeIcon,
